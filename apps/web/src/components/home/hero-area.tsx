            ...
            <div className="flex items-end lg:gap-8">
                ...
                <div className="flex flex-col gap-12 border-t border-t-[#171717] mt-20 pt-20">
                    ...
                    <div className=" w-full border border-[#232323] rounded-md flex flex-wrap gap-3 p-6 text-[#C0C0C0]">
                        <a href="/docs" className="bg-black border border-zinc-800 py-1 px-3 rounded">Button</a>
                        <a href="/docs" className="bg-black border border-zinc-800 py-1 px-3 rounded">Card</a>
                        <a href="/docs" className="bg-black border border-zinc-800 py-1 px-3 rounded">Input</a>
                        <a href="/docs" className="bg-black border border-zinc-800 py-1 px-3 rounded">Textarea</a>          
                    </div>
                </div>
            </div>      
    );
