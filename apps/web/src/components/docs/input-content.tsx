...
const InputContent = () => {
    return ( 
        <>
            ...
            <p className="text-[#C0C0C0]" >Displays a input component.</p>

            <Input placeholder="Start Typing" className="w-80 text-black focus:outline-none mt-10"/>
            ...
            <div className="my-10 space-y-2 w-full">
                 ...
                 <div className="bg-neutral-900 p-3 text-neutral-100 rounded-md w-full">
                        <p> import &#123; Input &#125; from &quot;doplo/input&quot;; </p>
                 </div>
            ...
            <div className="my-10 space-y-2">
                ...
                <p className="text-[#C0C0C0]">A Input component contain:</p>
                <ul className="list-disc list-inside text-[#C0C0C0]">
                        <li>
                        <span className="text-neutral-50">Input</span> : The styled input component.
                        </li>
                    </ul>
                <div className="aspect-[4/1.5] relative">
                    <Image
                        src="/docs/input-structure.svg"
                        alt="Input Structure"
                        fill
                    />
                </div>
