const ShowCasePage = () => {
    return ( 
        ...
        <div className="pt-24 px-12 space-y-4">
            <h1 className="text-4xl font-bold">Building something great with Doplo?</h1>
            <p className="text-[#C0C0C0] text-balance">I’d love to feature it! Send me a DM on <a href="/">X</a> or email me at <a href="mailto:hi@ayushtomar.in">hi@ayushtomar.in</a></p>
